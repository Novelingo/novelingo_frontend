      ...
      <GenerateTemplate subtitle="Write a description for your novel:">
        <div className=" w-80 md:w-2/4 ">
          <textarea
            ...
            className="h-64 w-full max-h-64 mt-6 text-dark  p-6 placeholder:text-purple md:text-base bg-light rounded shadow-sm focus:outline-none text-sm"
          ...
          <p className="text-light  text-sm w-full">
